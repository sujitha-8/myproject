...
<div class="header">
  ...
  <div class="header-right">
    ...
    <a href="donateBlood.jsp">Donate Blood</a>
...
<body>
  ...
  {
	  %>
	  <center><font color="red" size="5">Invaid Data! Try Again !</font></center>
	  <% 
  }
 ...
 <input type="text" name="email" placeholder="Enter Email Address" pattern="[a-z0-9._]+@gmail.com" required>
